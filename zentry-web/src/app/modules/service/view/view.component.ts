...
export class ViewComponent extends BaseDetachedComponent implements OnInit {
    ...
    private build(): void {
        this.form = this.fb.group({
            ...
            category: [this.entity.category, [Validators.required, Validators.maxLength(255), WhitespaceValidator]],
            status: [this.entity.status, [Validators.required, Validators.maxLength(255), WhitespaceValidator]],
            actions: [this.entity.actions, [Validators.required, Validators.maxLength(255), WhitespaceValidator]]
