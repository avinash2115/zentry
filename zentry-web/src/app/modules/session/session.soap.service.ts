...
@Injectable()
export class SessionSoapService implements OnDestroy {
    ...
    make(): SoapJsonapiResource {
        const entity: SoapJsonapiResource = this._sessionService.sessionSoapJsonapiService.new();
                ...
                switchMap((session: SessionJsonapiResource) => {
                    return new Observable<SoapJsonapiResource>((observer: Observer<SoapJsonapiResource>) => {
                        entity.save({
                            ...
                            const resource: SoapJsonapiResource = this._sessionService.sessionSoapJsonapiService.new();
    ...
    bulk(entities: Array<SoapJsonapiResource>): Observable<boolean> {
        return this._sessionService
            ...
            .pipe(
                take(1),
                switchMap((session: SessionJsonapiResource) => {
                    return this._http.post<IAcknowledgeResponse>(`${session.path}/relationships/${this._sessionService.sessionSoapJsonapiService.path}/bulk`, {
