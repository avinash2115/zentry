...
namespace App\Components\Providers\Http\Controllers;

use App\Assistants\Transformers\ValueObjects\JsonApi;
use App\Components\Providers\ProviderServices\Traits\ProviderServiceTrait;
 ...
 * Class Controller
 *
 * @package App\Components\Providers\Http\Controllers
 */
class Controller extends BaseController
{
    ...
    {
        $this->providerService__()->applyFilters($request->get('filter', []));

        return $this->sendResponse($this->providerService__()->list());
    }
    ...
    {
        return $this->sendResponse(
            $this->providerService__()->workWith($id)->change($jsonApi->attributes()->toArray())->dto()
        );
    }
    ...
    {
        return $this->sendResponse($this->providerService__()->workWith($id)->dto());
    }
    ...
    {
        $this->providerService__()->workWith($id)->remove();
